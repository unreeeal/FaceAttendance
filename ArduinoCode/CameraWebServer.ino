...
const char* ssid = "fractal";
const char* password = "kerogazich";
...
const char *googleScriptLink = ("https://script.google.com/macros/s/AKfycbwfUNHgafFkLpTs7jB4CpYOhlu_crHzpuL9OoZ82DO5A5ws5Urb/exec");
